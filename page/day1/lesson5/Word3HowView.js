...
export default class Word3HowView extends Component {
  ...
  render() {
    return (
      <WordDetailPage
        backgroundImage={require('../../../asset/day1/lesson5/word3_bg1.png')}
        ...
        <Text style={styles.content}>
          ...
          <Text style={{ fontSize: 26 }}>There is a hill in the zoo.</Text>
          <Text style={{ fontSize: 20 }}>{"\n"}{"\n"}</Text>
          <Text style={{ fontSize: 26 }}>You: Do you want to climb over the hill or go around it?{"\n"}Peale: Let's climb over it.</Text>
        </Text>
      </WordDetailPage>
    );
  }
