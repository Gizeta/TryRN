...
export default class Word3HowView extends Component {
  ...
  render() {
    return (
      <WordDetailPage
        backgroundImage={require('../../../asset/day1/lesson4/word3_bg1.png')}
        ...
        <Text style={styles.content}>
          ...
          <Text style={{ fontSize: 26 }}>The panda is so lovely.</Text>
          <Text style={{ fontSize: 20 }}>{"\n"}{"\n"}</Text>
          <Text style={{ fontSize: 26 }}>What a lovely baby!</Text>
        </Text>
      </WordDetailPage>
    );
  }
