...
export default class Word3ThinkView extends Component {
  ...
  render() {
    return (
      <WordDetailPage
        backgroundImage={require('../../../asset/day1/lesson2/word_welcome_bg2.png')}
        ...
        <Text style={styles.content}>
          ...
          <Text style={{ fontSize: 26 }}>warmly（热情地）/welcomer（欢迎者）</Text>
          <Text style={{ fontSize: 20 }}>{"\n"}{"\n"}</Text>
          <Text style={{ fontSize: 26 }}>Welcome home.（欢迎回家）</Text>
        </Text>
      </WordDetailPage>
    );
  }
