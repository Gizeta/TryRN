...
export default class Word1ThinkView extends Component {
  ...
  render() {
    return (
      <WordDetailPage
        backgroundImage={require('../../../asset/day1/lesson2/word_rain_bg2.png')}
        ...
        <Text style={styles.content}>
          ...
          <Text style={{ fontSize: 26 }}>raincoat(雨衣)/rainwater(雨水)/rainworm(蚯蚓)</Text>
          <Text style={{ fontSize: 20 }}>{"\n"}{"\n"}</Text>
          <Text style={{ fontSize: 26 }}>a rain of tears(泪如雨下)</Text>
        </Text>
      </WordDetailPage>
    );
  }
